...
int main() {
    ...
    glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 3 * sizeof(float), (void*)0); //glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 0, (void*)0);
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        int vertexColorLocation = glGetUniformLocation(shaderProgram, "ourColor"); //we do not need to use the shader program to get the uniform location
        glUseProgram(shaderProgram);
        glUniform4f(vertexColorLocation, 0.0f, greenValue, 0.0f, 10.0f); //we do need to use the shader program in order to set the value of the uniform
